...
namespace SpreadsheetTests
{
    ...
    ///</summary>
    [TestClass()]
    public class Spreadsheet2Provided
    {
        ...
        public void TestSetGetForm()
        {
            ...
            SpreadsheetUtilities.Formula f = (SpreadsheetUtilities.Formula)s.GetCellContents("Z7");
            Assert.AreEqual(new SpreadsheetUtilities.Formula("3"), f);
            Assert.AreNotEqual(new SpreadsheetUtilities.Formula("2"), f);
        }
        ...
        public void TestChangeStoF()
        {
            ...
            Assert.AreEqual(new SpreadsheetUtilities.Formula("23"), (SpreadsheetUtilities.Formula)s.GetCellContents("A1"));
            Assert.AreNotEqual(new SpreadsheetUtilities.Formula("24"), (SpreadsheetUtilities.Formula)s.GetCellContents("A1"));
        }
