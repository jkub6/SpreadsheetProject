...
namespace SpreadsheetTests
{
    ...
    ///</summary>
    [TestClass()]
    public class SpreadsheetProvided
    {
        ...
        public void LongFormulaHelper(out object result)
        {
            try
            {
                ...
                //Assert.AreEqual(Math.Pow(2, depth + 1), (double)s.GetCellValue("s1"), 1.0);
                s.SetContentsOfCell("a" + i, "0");
                //Assert.AreEqual(Math.Pow(2, depth), (double)s.GetCellValue("s1"), 1.0);
